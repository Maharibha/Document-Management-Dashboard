  ...
  const startUpload = () => {
    ...
    if (selectedFiles.length > 3) {
      setNotifications((prev) => [
        {
          message: `Processing ${selectedFiles.length} files in background`,
          type: "info",
        },
        ...prev,
      ]);
      ...
      <main className="p-8">
        ...
        <section className="bg-gradient-to-r from-blue-700 to-blue-500 text-white rounded-3xl p-8 mb-8 shadow-lg">
          <h2 className="text-3xl font-bold mb-2">
            Upload and manage company PDFs
          </h2>

          <p className="text-blue-100">
            Track upload progress, manage files,
            and receive smart notifications.
          </p>
        </section>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <section className="lg:col-span-2 bg-white rounded-3xl p-6 shadow">
            ...
            <div className="border-2 border-dashed border-blue-300 rounded-2xl p-10 text-center bg-blue-50">
              ...
              <label className="inline-block cursor-pointer bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-blue-700">
                Select PDF Files
              ...
              <button
                onClick={startUpload}
                className="mt-5 bg-green-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-green-700"
              >
                Upload Files
              </button>
            </div>
